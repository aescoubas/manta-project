...
## [0.1.19](https://github.com/aescoubas/manta-project/releases/tag/manta-ws-v0.1.19) - 2025-08-18
...
- test ([#39](https://github.com/aescoubas/manta-project/pull/39))
- Feat/myfeat ([#37](https://github.com/aescoubas/manta-project/pull/37))
- Feat/newfeat ([#35](https://github.com/aescoubas/manta-project/pull/35))
- test ([#36](https://github.com/aescoubas/manta-project/pull/36))
- Feat/newfeat ([#34](https://github.com/aescoubas/manta-project/pull/34))
- release-plz manta-ws
- release-plz manta-ws
- release-plz toto
- release-plz toto
